...
contract BondingEvent is AccessControl {
    ...
    function setStorageContract(address _newAddress) public onlyPoolOwner validAddress(_newAddress) { bondStorageAddress = _newAddress; }
    ...
    function increaseMagnitude(int24 _magnitude) private pure returns (int24 magnitude, uint8 i) { magnitude = _magnitude * 10; }
